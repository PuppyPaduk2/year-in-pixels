define([
   'Views/ButtonArea',
   'Views/Menu'
], function(ButtonArea, Menu) {
   'use strict';
   
   return ButtonArea.extend({
      /**
      ...
      initialize: function (options) {
         ...
         ButtonArea.prototype.initialize.apply(this, arguments);
      },
      ...
      createPanel: function() {
         ...
         return ButtonArea.prototype.createPanel.apply(this, arguments);
      }
   });
});